...
class _Step2TabState extends State<Step2Tab> {
  ...
  void didUpdateWidget(oldWidget) {
    if (oldWidget.isLoading != widget.isLoading) widget.isSuccessful.consume();
